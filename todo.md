...
* to push to staging (fyi has public cdot access): 
  * `cd src; gsutil -m cp -r  *   gs://dev.yetalittlewhile.com/`
  * check it out at [dev.yetalittlewhile.com](https://dev.yetalittlewhile.com)
* to push to the broad cdot world of prod: 
  * `cd src; gsutil -m cp -r  *   gs://yetalittlewhile.com/`
